...
The `pypher-password` project and all its source code have been developed strictly for educational, cybersecurity research, and Proof of Concept (PoC) purposes. This tool is designed to help security professionals, system administrators, and students better understand password security and cryptography.

**2. Ethical and Legal Use**
Using this tool to attack, exploit, or attempt to access systems, networks, or accounts without the explicit and prior consent of their respective owners is strictly illegal. It is the absolute responsibility of the end-user to ensure that the use of this tool complies with all applicable local, state, national, and international laws.

**3. No Liability**
The author(s) and contributors of `pypher-password` **assume NO liability** and are not responsible for any misuse, direct or indirect damage, or legal consequences caused by the use of this tool. By downloading, cloning, or using this software, you agree that you do so entirely at your own risk.
