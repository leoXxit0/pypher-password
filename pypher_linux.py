...
class WordlistGenerator:
    ...
    # Diccionario base: >100 palabras realmente usadas en contraseñas.
    DICCIONARIO_BASE = [
        "admin", "password", "qwerty", "love", "dragon", "master", "monkey",
        "football", "baseball", "welcome", "iloveyou", "princess", "sunshine",
        "shadow", "letmein", "freedom", "whatever", "trustno1", "superman",
        "batman", "spiderman", "pokemon", "starwars", "matrix", "terminator",
        "hacker", "cyber", "security", "passport", "private", "secret",
        "mypass", "pypher", "python", "linux", "windows", "ubuntu", "debian",
        "archlinux", "fedora", "kali", "parrot", "raspberry", "jordan23",
        "michael", "jennifer", "hunter", "ranger", "soccer", "hockey",
        "ferrari", "mustang", "corvette", "tiger", "phoenix", "ninja",
        "samurai", "warrior", "angel", "cookie", "chocolate", "coffee",
        "guitar", "music", "summer", "winter", "autumn", "spring", "google",
        "facebook", "instagram", "twitter", "youtube", "amazon", "apple",
        "microsoft", "oracle", "cisco", "netgear", "tplink", "dlink",
        "huawei", "samsung", "iphone", "android", "gaming", "gamer",
        "level99", "chelsea", "arsenal", "liverpool", "barcelona", "madrid",
        "juventus", "brazil", "mexico", "canada", "america", "london",
        "paris", "tokyo", "berlin", "hello123", "test123", "changeme",
        "opensesame", "ilovegod", "jesus", "family", "mother", "father",
        "baby", "forever", "always", "friend", "buddy", "rockstar",
        "legend", "victory", "champion", "winner", "thunder", "lightning",
        "storm", "fire", "ice", "water", "earth", "wind",
    ]
    ...
    # -----------------------------------------------------------------
    def mostrar_alias_rapido(self):
        ruta_script = os.path.abspath(__file__) if '__file__' in globals() else "/ruta/completa/a/pypher_linux.py"
        print(f"{self.colores['morado']}│ {self.colores['gris']}💡 Acceso rápido: crea un alias para no escribir la ruta completa:")
        print(
            f"{self.colores['morado']}│ {self.colores['cyan']}   echo 'alias pypher=\"python3 {ruta_script}\"' >> ~/.bashrc "
            f"&& source ~/.bashrc{self.colores['reset']}"
        )
        print(f"{self.colores['morado']}│ {self.colores['gris']}   Después, solo escribe {self.colores['blanco']}pypher{self.colores['gris']} para ejecutar el programa.{self.colores['reset']}")
